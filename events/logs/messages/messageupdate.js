...
module.exports = {
    ...
    execute(oldMessage, newMessage) {
        ...
        let embed = new Discord.MessageEmbed()
            ...
            .addField(`🖊️ Vecchio Contenuto:`, oldMessage.content.toString() ? (oldMessage.content.length > 500 ? `${oldMessage.content.slice(0, 497)}...` : oldMessage.content.toString()) : `_Nessun Contenuto_`, true)
            .addField(`\u200b`, `\u200b`, true)
            .addField(`🖊️ Nuovo Contenuto:`, newMessage.content.toString() ? (newMessage.content.length > 500 ? `${newMessage.content.slice(0, 497)}...` : newMessage.content.toString()) : `_Nessun Contenuto_`, true)
