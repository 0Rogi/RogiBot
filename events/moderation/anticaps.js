...
module.exports = {
    ...
    execute(message) {
        ...
        if (message.member.permissions.has(`MANAGE_MESSAGES`) || message.member.roles.cache.has(config.idruoli.friend) || message.member.roles.cache.has(config.idruoli.vip) || message.author.bot) return
