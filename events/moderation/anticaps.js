...
module.exports = {
    ...
    execute(message) {
        ...
        if (message.member.roles.cache.has(config.idruoli.staff) || message.member.roles.cache.has(config.idruoli.friend) || message.member.roles.cache.has(config.idruoli.vip) || message.author.bot) return
