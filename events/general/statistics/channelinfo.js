            ...
            switch (channel.type) {
                case `GUILD_TEXT`: {
                    ...
                    embed
                        ...
                        .addField(`🗓️Date Creazione:`, `${moment(channel.createdAt).format(`ddd DD MMM YYYY, HH:mm:ss`)} (${moment(channel.createdAt).fromNow()})`)
                        .addField(`💬Ultimo Messaggio:`, `${m == `_Nessun Messaggio_` ? m : m.content ? m.content : `_Nessun Contenuto_`}`)
                } break
                case `GUILD_VOICE`: {
                    embed
                        .addField(`📡Tipo:`, `Vocale`, true)
                        .addField(`⛓️Limite di utenti:`, channel.userLimit == `0` ? `_Nessun Limite_` : channel.userLimit.toString(), true)
                        .addField(`🚨ID:`, channel.id.toString(), true)
                        .addField(`📁Categoria:`, interaction.guild.channels.cache.find(c => c.id == channel.parentId).name, true)
                        .addField(`🗓️Date Creazione:`, `${moment(channel.createdAt).format(`ddd DD MMM YYYY, HH:mm:ss`)} (${moment(channel.createdAt).fromNow()})`)
                } break
                ...
                case `GUILD_STAGE_VOICE`: {
                    embed
                        ...
                        .addField(`⛓️Limite di utenti:`, channel.userLimit.toString(), true)
                        .addField(`🚨ID:`, channel.id.toString(), true)
                        .addField(`📁Categoria:`, interaction.guild.channels.cache.find(c => c.id == channel.parentId).name, true)
                        .addField(`🗓️Date Creazione:`, `${moment(channel.createdAt).format(`ddd DD MMM YYYY, HH:mm:ss`)} (${moment(channel.createdAt).fromNow()})`)
                } break
