    ...
    async execute(interaction) {
        ...
        if (interaction.customId.startsWith(`roleinfoplus`)) {
            ...
            let embed = new Discord.MessageEmbed()
                ...
                .addField(`🖲️Menzionabile?`, role.mentionable ? `Sì` : `No`, true)
                .addField(`🧬Colore:`, role.hexColor, true)
                .addField(`👥Utenti:`, i.toString(), true)
                .addField(`🗓️Date Creazione:`, `${moment(role.createdAt).format(`ddd DD MMM YYYY, HH:mm:ss`)} (${moment(role.createdAt).fromNow()})`)
