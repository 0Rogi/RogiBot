...
module.exports = {
    ...
    execute(message) {
        ...
        if (message.id == serverstats.countinginfinity.messageid) {
            let sentences = [` si sente simpatico ad eliminare i numeri 🤡`, `? Perchè elimini i numeri? 🤨`, ` ma cosa elimini i numeri..? 🤦‍♂️`, ` a quanto pare non hai di meglio da fare se sei qui ad eliminare i numer 😌`, ` il bro elimina i numeri 🗿`, ` AHAHAHAHAHHAHAHAHAHHAHAH, proprio divertente lo scherzo di eliminare i numeri 😂😂😂🤣🤣🤣`];
