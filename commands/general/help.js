    ...
    async execute(message) {
        ...
        let row = new Discord.MessageActionRow()
			...
			.addOptions([
                        ...
                        {
                            label: 'Easter',
                            description: 'Comandi dell\'evento di Pasqua',
                            value: 'Easter',
                            emoji: '<:EasterEgg:962650324022222909>'
                        },
                        {
                            label: 'Owner',
        ...
        collector.on(`collect`, i => {
            ...
            if(i.values[0] == `Easter` || i.values[1] == `Easter`) {
                if(i.user.id != message.author.id) return i.reply({content: `Non è un tuo menu`,  ephemeral: true})
                let embed = new Discord.MessageEmbed()    
                    .setTitle(`<:EasterEgg:962650324022222909> Comandi dell'evento di Pasqua <:EasterEgg:962650324022222909>`)
                    .setDescription(`**!eggspawn**<:EventTag:947064431215513610><:StaffTag:942016780363243531>\nPermette di generare un uovo in una stanza a caso\n**!lb**\nPermette di vedere la leaderboard di chi ha più punti\n**!open**<:EventTag:947064431215513610>\nPermette di aprire un uovo\n**!removecooldown**<:EventTag:947064431215513610><:StaffTag:942016780363243531>\nPermette di rimuovere il cooldown per raccogliere le uova\n**!stats**\nPermette di vedere le statistiche di qualcuno dell'evento di Pasqua`)
                    .setColor(`YELLOW`)
                i.update({embeds: [embed]})
            }
        })
