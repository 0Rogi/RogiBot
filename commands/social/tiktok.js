module.exports = {
    ...
    execute(message) {
        ...
        let row = new Discord.MessageActionRow().addComponents(new Discord.MessageButton().setLabel(`TIK TOK`).setStyle(`LINK`).setURL(`https://www.tiktok.com/@rogi23yt?`).setEmoji(`<:tiktok:959490766747611166>`))
